            ...
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                <dd
                  ...
                  :key="item.id"
                  @click="changeActive(item, attr.spuSaleAttrValueList)"
                >
...
export default {
  ...
  mounted() {
    ...
    // this.$store.dispatch('detail/getGoodsList',1)
  },
  computed: {
  ...
  methods: {
    ...
    changeNum(e) {
      ...
      if (isNaN(res) || res < 1) {
        ...
        //小数
        this.skuNum = Math.floor(res);
      }
    },
    async addShopcar() {
      //发请求1.
      try {
        let result = await this.$store.dispatch("detail/addOrUpdateShopCart", {
          skuNum: this.skuNum,
